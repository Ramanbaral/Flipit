...
const CATEGORIES = [
  ...
  { id: 'sports-outdoors', label: 'Sports & Outdoors', icon: Dumbbell, count: null },
  { id: 'books-media', label: 'Books & Media', icon: BookOpen, count: null },
  { id: 'gaming', label: 'Gaming', icon: Gamepad2, count: null },
  { id: 'toys-games', label: 'Toys & Games', icon: Puzzle, count: null },
  { id: 'baby-kids', label: 'Baby & Kids', icon: Baby, count: null },
  { id: 'beauty-personal-care', label: 'Beauty & Personal Care', icon: Sparkles, count: null },
  { id: 'appliances', label: 'Appliances', icon: Plug, count: null },
  { id: 'tools-diy', label: 'Tools & DIY', icon: Wrench, count: null },
  { id: 'office-business', label: 'Office & Business', icon: Briefcase, count: null },
  { id: 'pet-supplies', label: 'Pet Supplies', icon: PawPrint, count: null },
  { id: 'musical-instruments', label: 'Musical Instruments', icon: Music, count: null },
  { id: 'photography-videography', label: 'Photography & Videography', icon: Camera, count: null },
  { id: 'jewelry-watches', label: 'Jewelry & Watches', icon: Watch, count: null },
  { id: 'art-crafts', label: 'Art & Crafts', icon: Palette, count: null },
  { id: 'collectibles', label: 'Collectibles', icon: Gem, count: 96 },
  { id: 'health-medical', label: 'Health & Medical', icon: HeartPulse, count: null },
];
